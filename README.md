...
| `LOCALHOST_BYPASS_AUTH`        | Optional, allows localhost access to bypass authentication. ⚠️ **WARNING: MUST be set to `false` in production environments!** This feature is designed for local development only. | `true`                                                                                                                                                                                                                                   |
| **TTS Related**                |                                                                             |                                                                                                                                                                                                                                          |
